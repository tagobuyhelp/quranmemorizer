...
export function StudentSelector({ selectedStudent, onSelect }: StudentSelectorProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
            ...
            <div className="flex items-center justify-between w-full ">
              <div className="text-left">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <span className="ml-2">{String(selectedStudent.teacherId)}</span>
                </div>
              </div>
      ...
      <PopoverContent className="w-full bg-white p-0" style={{ width: "var(--radix-popover-trigger-width)" }}>
        <Command>
          <CommandInput
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        <span className="text-gray-500">•</span>
                        <span className="ml-2">{String(student.teacherId)}</span>
                      </div>
                    </div>
                  </div>
                  <div className="text-xs text-gray-500">
